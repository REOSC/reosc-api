...
var MN_SERVER_IP = "localhost"; // Replace with your MN server IP ex: 85.22.123.82
var INSTANCE_NAME = "REOSC_Masternode"; // Replace with your desired Masternode name
var WS_SECRET = "the_secret";
...
Node.prototype.startWeb3Connection = function()
{
	...
	web3 = new Web3();
	web3.setProvider(new web3.providers.HttpProvider('http://' + (process.env.RPC_HOST || MN_SERVER_IP) + ':' + (process.env.RPC_PORT || '8545')));
...
Node.prototype.startSocketConnection = function()
{
	if( !this._socket )
	{
		...
		socket = new Socket( process.env.WS_SERVER || 'ws://stats.reosc.io:3001' );
